...
def parse_results_notification():
        ...
        processed_dir_path = './processed_results_new/'
        for i in range(11):
...
def process_detailed_logs():
        dir_path = './processed_results_new/'
        processed_dir_path = './processed_results_new_logs/'
        for i in range(11):
                for file in os.listdir(dir_path):		
                        id = file.replace('container_','')  
...
def process_resources():
        dir_path = './processed_results_new_logs/'
        for i in range(11):
                for file in os.listdir(dir_path):		
                        id = file.replace('container_','')  
                        if os.path.exists(dir_path+file+'/'+str(i)):
