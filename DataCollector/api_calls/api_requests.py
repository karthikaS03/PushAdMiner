...
fetch_score_api = 'https://g6ekhqhjo1.execute-api.us-east-2.amazonaws.com/default/notification_db_score_fetch?'
...
def fetch_urls_score(count,start):
    api_url = "{}count={}&start={}"
    api_url = api_url.format(fetch_score_api,str(count),str(start))
