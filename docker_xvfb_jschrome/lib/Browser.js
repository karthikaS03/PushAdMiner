...
/**
   ...
   * @param {!Array<string>} permissions
   */
  /* async */ overrideNotificationPermission(origin) {return (fn => {
    ...
    return new Promise((resolve, reject) => {
      ...
      process.stdout.write(this._defaultContext);
      (yield this._connection.send('Browser.grantNotificationPermission', {origin}));
    });}
