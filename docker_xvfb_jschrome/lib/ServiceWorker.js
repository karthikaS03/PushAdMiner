...
class ServiceWorker extends EventEmitter {
  ...
  constructor(client, target) {
    ...
    //client.on('ServiceWorkerGlobalScope.onpush', async event => {console.log('push')})
    //client.on('ServiceWorkerGlobalScope.onnotificationclick', async event => {console.log('click')})
  }
