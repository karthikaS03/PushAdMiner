...
void MessageCenterDisplayService::Display(
  ...
  if (notification.delegate() || notification_type == NotificationHandler::Type::TRANSIENT) {
    // :: Forensics ::  
    // Adds the next notification to the display queue after a delay of 10 seconds
    sleep(10);    
